    ...
    var body: some View {
        NavigationStack {
            List {
                ...
                Section("About") {
                    Link("Privacy Policy", destination: URL(string: "https://shimondeitel.github.io/iceout-app/privacy.html")!)
                    Link("Terms of Use", destination: URL(string: "https://shimondeitel.github.io/iceout-app/terms.html")!)
                }
            }
